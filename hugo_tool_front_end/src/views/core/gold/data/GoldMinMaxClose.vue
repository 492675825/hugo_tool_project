<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column prop="min_close" label="最低收盘价"/>
      <el-table-column prop="min_close_version_date" label="最低收盘价日期"/>
      <el-table-column prop="min_close_month" label="最高收盘所在月"/>
      <el-table-column prop="max_close" label="最高收盘价"/>
      <el-table-column prop="max_close_version_date" label="最高收盘价日期"/>
      <el-table-column prop="max_close_month" label="最高收盘价所在月"/>
    </el-table>
...
export default {
  ...
  methods: {
    dataList() {
      axios({
        method: 'get',
        url: this.baseLink.baseURL + '/gold/close_data',
        params: {
